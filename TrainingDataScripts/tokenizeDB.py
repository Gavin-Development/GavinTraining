...
subword_file = "Tokenizer-1"  # input("Please enter the name of the subword file: ")
...
for database in databases:
    ...
    sql = "CREATE TABLE IF NOT EXISTS tokenized_comment_data (parent_id TEXT PRIMARY KEY, comment_id TEXT UNIQUE, parent_tokenized TEXT, comment_tokenized TEXT, subreddit TEXT, unix INT, score INT, tokenizer_name TEXT)"
